...
| Project Plan Post 7 of 7: Budget | This initial project budget should be a forecast for future spending along with a justification for why the money should be spent this way, we realise this will change over the course of the project.  Please do not reveal any personal details in the budget.  Use 'National Framework Agreement' job titles and costing to reveal staff costs | projectPlan, budget, yourUniqueProjectTag, jiscDEPO, jisc |
...
|:-----------------------------------|:--------------------------|:------------------|
| "Project Evaluation" aka iterative reflection | Undertake a quick iterative evaluation process, aka something that can be done when you are waiting for public transport ro a good way to kick off a meeting (e.g.[SWOT analysis](http://en.wikipedia.org/wiki/SWOT_analysis)).  The key is to truly knowing thyself or at least your project. | SWOT, projectEvaluation, jiscDEPO, progressPost, JISC, [yourUniqueProjectTag](yourUniqueProjectTag.md), etc. |
| "User participation" aka use cases | What is the core user case(s) you think of when developing; how has this story changed as you have engaged with the end user e.g. "we often talk about Sam the part time working student we met while at...".  Bonus points for actually talking about real end-users you are working with (note: you are not the end user!) | userCase, endUser, jiscDEPO, progressPost, JISC, [yourUniqueProjectTag](yourUniqueProjectTag.md), etc. |
